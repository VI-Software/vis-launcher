    ...
    authKeys.forEach((val) => {
        ...
        const accHtml = `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            <div class="settingsAuthAccountLeft">
                <img class="settingsAuthAccountImage" alt="${acc.displayName}" src="https://skins.visoftware.dev/2d/skin/${acc.uuid}/fullbody?scale=10">
            </div>
...
async function loadSelectedServerOnModsTab(){
    ...
    for(const el of document.getElementsByClassName('settingsSelServContent')) {
        el.innerHTML = `
            <img class="serverListingImg" src="${serv.rawServer.icon}" style="width: 64px; height: 64px; margin: 0 20px;"/>
            <div class="serverListingDetails" style="padding: 12px 0;">
